...
APP_LINK_SUPPORTED_PLATFORMS = frozenset({PLATFORM_WEIBO, PLATFORM_XUEQIU})
WEIBO_HOST_SUFFIXES = frozenset({"weibo.com", "weibo.cn"})
WEIBO_DETAIL_PATH_HEADS = frozenset({"status", "detail"})
XUEQIU_HOST_SUFFIX = "xueqiu.com"
XUEQIU_HTML_SUFFIX = ".html"
XUEQIU_STOCK_PATH_HEAD = "S"
